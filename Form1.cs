...
namespace Lab4VS
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e) //Button 1 = Start
        {
        ...
        private void button2_Click(object sender, EventArgs e) //Button 2 = Stop
        {
            serialPort1.Close();
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            if (!string.Equals(textBox1.Text, ""))
            {
                ...
                try
                {
                    ...
                    const string WRITEKEY = "AINV5SB0DU8D72NZ";
